...
import { dispatchRenderComplete, url } from '../../../../../../../../../src/plugins/kibana_utils/public';
import { DOC_HIDE_TIME_COLUMN_SETTING } from '../../../../common';
import cellTemplateHtml from '../components/table_row/cell.html';
import truncateByHeightTemplateHtml from '../components/table_row/truncate_by_height.html';
import { esFilters } from '../../../../../../../../../src/plugins/data/public';
import { getServices } from '../../../../kibana_services';
import { formatField } from '../../../../../lib/format_hit';
  ...
  return {
    ...
    link: ($scope: LazyScope, $el: JQuery) => {
      ...
      function getDiscoverPath(){
        ...
        return `${location.origin}${pathName.replace('psafe#', 'discover')}`;
      }
      ...
      function _displayField(row: any, fieldName: string, truncate = false) {
        const indexPattern = $scope.indexPattern;
        const text = `<span ng-non-bindable>${formatField(row, fieldName, indexPattern)}</span>`;
