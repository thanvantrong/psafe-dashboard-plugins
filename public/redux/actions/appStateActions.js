...
/**
 * Updates PsafeNotReadyYet in the appState store
 * @param psafeNotReadyYet
 */
export const updatePsafeNotReadyYet = psafeNotReadyYet => {
  return {
    type: 'UPDATE_PSAFE_NOT_READY_YET',
    psafeNotReadyYet: psafeNotReadyYet
  };
};
