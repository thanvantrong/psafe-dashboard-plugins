/*
 * Psafe app - Pattern Handler service
...
export class PatternHandler {
  ...
  static async getPatternList(origin) {
    try {
      ...
      const { pattern } = psafeConfig.getConfig();
      ...
      let patternList = await SavedObject.getListOfPsafeValidIndexPatterns(defaultPatterns, origin);
