/*
 * Psafe app - React test for pa-user-permissions
...
import { PaUserPermissions } from './pa-user-permissions';
...
describe('Psafe User Permissions', () => {
  describe('Given a Json with permissions that the user does not have', () => {
    describe('Should return a simple required permissions to show on view', () => {
      it('Should return a simple missing permissions for manager user', () => {
        ...
        const result = PaUserPermissions.checkMissingUserPermissions(simplePermission, {
          'lists:read': {
            'list:path:*': 'allow',
          },
          rbac_mode: 'white',
    ...
    describe('Should return all permissions ok', () => {
      it('Should return all permissions ok for manager user', () => {
        ...
        const result = PaUserPermissions.checkMissingUserPermissions(
          simplePermission,
          userManagerTest
        );
