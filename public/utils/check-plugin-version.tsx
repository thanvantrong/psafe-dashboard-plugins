/*
 * Psafe app - Tools to check the version of the plugin
...
const checkClientAppVersion = (appInfo: TAppInfo) => {
  if (appInfo['app-version'] !== appVersion || appInfo.revision !== appRevision) {
    const toastOptions: ErrorToastOptions = {
      title: 'Conflict with the Psafe app version',
      toastLifeTimeMs: 50000,
      toastMessage: `The version of the Psafe app in your browser does not correspond with the app version installed in ${PLUGIN_PLATFORM_NAME}. Please, clear your browser cache. For more info check the full error.`,
    };
    ...
    const message: ReactNode = (
      <>
        <p>
          The version of the Psafe app in your browser{' '}
          <b>
...
This message should not be displayed again.`;
    ...
    if (window.history.state == 'refreshed') {
      window.history.replaceState('', 'psafe');
    }
