// /*
//  * Psafe app - React component building the welcome screen of an agent.
...
//   const psafeDevTools = useRef(null);
...
//   const handleResize = () => {
//     $('#pa-dev-left-column').css('width', '30%');
//     $('#pa-dev-right-column').css('width', '70%');
//     const gutter = $('#pa-dev-right-column .ace_gutter');
//     const gutterWidth = gutter.width();
//     const gutterOffset = gutter.offset();
//     $('#pa-tabs-margin').css('marginRight', gutterWidth + gutterOffset.left - 66); //66 is the width of the History button
//   };

//   useEffect(() => {
//     editorInstanceRef.current = senseEditor.create(editorRef.current!);
//     psafeDevTools.current = { tabs: tabsState, selectedTab, statusBadges };
...
//     $('.pa-dev-column-separator').mousedown(function (e) {
//       e.preventDefault();
//       $('.pa-dev-column-separator').addClass('active');
//       const leftOrigWidth = $('#pa-dev-left-column').width();
//       const rightOrigWidth = $('#pa-dev-right-column').width();
//       const gutter = $('#pa-dev-right-column .ace_gutter');
...
//         const gutterWidth = gutter.width();
//         const gutterOffset = gutter.offset();
//         $('#pa-dev-left-column').css('width', leftWidth);
//         $('#pa-tabs-margin').css('marginRight', gutterWidth + gutterOffset.left - 66); //66 is the width of the History button
//         $('#pa-dev-right-column').css('width', rightOrigWidth + rightWidth);
//       });
//     });

//     $(evtDocument).mouseup(function () {
//       $('.pa-dev-column-separator').removeClass('active');
...
//   const addNewTab = () => {
//     const tabsLength = psafeDevTools.current.tabs.length;
//     if (tabsLength < 5) {
//       const newTabs = [...psafeDevTools.current.tabs];
//       newTabs[tabsLength] = '';
//       setTabs(newTabs);
//       const newBadges = [...psafeDevTools.current.statusBadges];
...
//     window.localStorage.setItem(`psafe:history.elem_${time}`, JSON.stringify(newReq));
//   }
...
//         const response = await PaRequest.apiReq(currentReq.method, url, { ...params, ...bodyParams });
...
//         const newTabs = [...psafeDevTools.current.tabs];
//         newTabs[psafeDevTools.current.selectedTab] = `#${currentReq.method} ${currentReq.url}\n${JSON.stringify(formattedResponse, null, 1)} \n\n`;
//         setTabs(newTabs);
//         const newBadges = [...psafeDevTools.current.statusBadges];
//         newBadges[psafeDevTools.current.selectedTab] = badgeStatus;
//         setStatusBadges(newBadges);
//         setLoading(false);
//         return;
//       }
...
//     };
//     const newTabs = [...psafeDevTools.current.tabs];
//     newTabs[psafeDevTools.current.selectedTab] = result;
//     setTabs(newTabs);
//     const newBadges = [...psafeDevTools.current.statusBadges];
//     newBadges[psafeDevTools.current.selectedTab] = { statusCode: 200, statusText: 'OK' };
//     setStatusBadges(newBadges);
//     setLoading(false);
//   }
...
//     $('#pa-dev-right-column').on('resizeComponent',function(){
//       let $rightColumn = $('#pa-dev-right-column');
...
//     return (
//       <div id="pa-dev-right-column" style={{ width: "70%", minWidth: "30%",borderTop: '1px solid #8080801c', height: '100%' }}>
//         <EuiCodeEditor
//           // theme="textmate"
//           width="100%"
//           height="100%"
...
//     return (
//       <div id="pa-dev-left-column" style={{ width: "30%", borderTop: '1px solid #8080801c' }} className="conApp__editor">
...
//         <EuiFlexItem id="pa-tabs-margin" style={{ marginRight: 'calc(30vw - 4px)' }} grow={false}>
//           <EuiButtonEmpty
//             color="text"
//             onClick={showHistory}
//           >
...
//             </EuiButtonEmpty>
//         </EuiFlexItem>
//         <EuiFlexItem className="pa-devtools-tabs" style={{ zIndex: 1 }}>
...
//             {renderLeftColumn()}
//             <div className="pa-dev-column-separator layout-column" style={{ marginTop: 0, borderTop: '1px solid #8080801c' }}>
