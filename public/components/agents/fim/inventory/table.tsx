...
import { filtersToObject, IFilter } from '../../../pa-search-bar';
...
export class InventoryTable extends Component {
  ...
  async showFlyout(file, item, redirect = false) {
    ...
    if (!redirect) {
      ...
      const response = await PaRequest.apiReq('GET', `/syscheck/${this.props.agent.id}`, {
        params: {
          file: file,
        },
      });
  ...
  async getSyscheck() {
    ...
    try {
      const syscheck = await PaRequest.apiReq('GET', `/syscheck/${agentID}`, {
