/*
 * Psafe app - Agent vulnerabilities components
...
import { ICustomBadges } from '../../pa-search-bar/components';
...
export class Inventory extends Component {
  ...
  // This method was created because Psafe API returns 1970-01-01T00:00:00Z dates or undefined ones
        ...
        <EuiStat
          ...
          title={(
            <EuiToolTip position="top" content={`Filter by Severity`}>
              <span
                className={'statWithLink pa-user-select-none'}
  ...
  render() {
    ...
    return <EuiPage>
      <EuiPageBody>
        <EuiFlexGroup wrap>
          <EuiFlexItem>
            <EuiCard title description betaBadgeLabel="Severity" className="pa-euiCard-no-title pa-euiCard-children-full-height">
          ...
          <EuiFlexItem>
            <EuiCard title description betaBadgeLabel="Summary" className="pa-euiCard-no-title">
