/*
 * Psafe app - Integrity monitoring table component
...
export class RowDetails extends Component {
  ...
  async componentDidMount() {
    ...
    const rulesDataResponse = await PaRequest.apiReq('GET', `/rules`, { params });
  ...
  getFormattedDetails(value) {
    ...
    if (Array.isArray(value) && value[0].type) {
      ...
      return (
        <PaTextWithTooltipTruncated position='top'>
          {_value}
        </PaTextWithTooltipTruncated>
      );
    }
  }
