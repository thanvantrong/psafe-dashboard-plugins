...
export const Discover = compose(
  ...
  class Discover extends Component {
    ...
    hideCreateCustomLabel = () => {
      try {
        const button = document.querySelector(
          '.pa-discover #addFilterPopover > div > button > span > span'
        );
    ...
    buildFilter() {
      ...
      const { hideManagerAlerts } = this.psafeConfig.getConfig();
      const extraFilters = [];
    ...
    render() {
      ...
      return (
        <div className="pa-discover hide-filter-control pa-inventory">
