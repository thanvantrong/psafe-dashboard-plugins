/*
 * Psafe app - Simple description for each App tabs
...
export interface PaOverlayMaskInterface {
  /**
...
export type EuiOverlayMaskProps = 
  Omit<
    ...
    keyof PaOverlayMaskInterface
  > &
  PaOverlayMaskInterface;

export const PaOverlayMask: FunctionComponent<EuiOverlayMaskProps> = ({
  className,
  children,
  onClick,
