/*
 * Psafe app - React HOCs to manage user authorization requirements
...
import { PaEmptyPromptNoPermissions } from '../permissions/prompt';
...
import { withUserLogged } from './withUserLogged'
 ...
 const withUserAuthorizationPromptChanged = (permissions = null, roles = null) => WrappedComponent => props => {
  ...
  return (userPermissionRequirements || userRolesRequirements) ? <PaEmptyPromptNoPermissions permissions={userPermissionRequirements} roles={userRolesRequirements} /> : <WrappedComponent {...props} />;
}
