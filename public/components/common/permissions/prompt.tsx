/*
 * Psafe app - Prompt component with the user required permissions and/or roles
...
export const PaEmptyPromptNoPermissions = withErrorBoundary(
          ...
          <Fragment>
            {permissions && (
              <div>
                ...
                {PaPermissionsFormatted(permissions)}
              </div>
            )}
...
export const PaPromptPermissions = ({
  permissions = null,
  roles = null,
  children,
  ...rest
