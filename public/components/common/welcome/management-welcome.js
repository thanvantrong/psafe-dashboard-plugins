/*
 * Psafe app - React component for building the management welcome screen.
 *
...
class ManagementWelcome extends Component {
  ...
  render() {
    return (
      <PaReduxProvider>
        <EuiPage className="pa-welcome-page">
          <EuiFlexGroup>
            <EuiFlexItem>
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Psafe cluster rules."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Psafe cluster decoders."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Psafe cluster CDB lists."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Psafe cluster configuration."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem />
                </EuiFlexGroup>
                ...
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Manage your Psafe cluster status."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Visualize your Psafe cluster."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Logs from your Psafe cluster."
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Check your stored Psafe reports."
                    />
                  </EuiFlexItem>
                </EuiFlexGroup>
                <EuiFlexGroup>
                  <EuiFlexItem>
                    <EuiCard
                      ...
                      description="Information about the Psafe environment"
                    />
                  </EuiFlexItem>
                  <EuiFlexItem>
                  </EuiFlexItem>
