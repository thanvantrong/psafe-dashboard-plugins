...
class PaGlobalBreadcrumb extends Component {
    ...
    return (
      <div>
        {!!this.props.state.breadcrumb.length && (
          <EuiBreadcrumbs
            className='pa-global-breadcrumb'
            responsive={false}
            truncate={false}
            max={6}
            ...
            aria-label="Psafe global breadcrumbs"
          />
        )}
      </div>
    )
...
export default connect(mapStateToProps, null)(PaGlobalBreadcrumb);
