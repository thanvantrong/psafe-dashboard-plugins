/*
 * Psafe app - React component which renders a field search bar
...
interface IPaFieldSearchBarProps{
...
export const PaFieldSearch = ({searchDelay, onSearch, onChange, ...rest}: IPaFieldSearchBarProps) => {
