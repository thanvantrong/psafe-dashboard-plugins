...
import { PaButtonPermissions } from '../../../common/permissions/button';
        ...
        <EuiFlyoutHeader hasBorder={false}>
          <EuiTitle size="m">
            <h2>
              ...
              {PaAPIUtils.isReservedID(currentUser.id) && (
            ...
            <EuiPanel>
              ...
              <EuiFormRow label="" helpText="Set if the user is able to use run as">
                <PaButtonPermissions
                  ...
                  aria-label=""
                  disabled={PaAPIUtils.isReservedID(currentUser.id)}
                />
              </EuiFormRow>
            </EuiPanel>
            <EuiSpacer />
            ...
            <EuiPanel>
              ...
              <EuiFormRow label="" helpText="Assign roles to the selected user">
                <EuiComboBox
                  ...
                  isDisabled={PaAPIUtils.isReservedID(currentUser.id)}
                />
              </EuiFormRow>
            </EuiPanel>
            ...
            <EuiFlexGroup>
              <EuiFlexItem grow={false}>
                <EuiButton
                  fill
                  isLoading={isLoading}
                  isDisabled={PaAPIUtils.isReservedID(currentUser.id) || !showApply}
                  onClick={editUser}
                >
                  Apply
                </EuiButton>
