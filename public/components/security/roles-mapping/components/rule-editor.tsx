...
import { PSAFE_SECURITY_PLUGIN_OPEN_DISTRO_FOR_ELASTICSEARCH } from '../../../../../common/constants';
...
export const RuleEditor = ({ save, initialRule, isLoading, isReserved, internalUsers, currentPlatform,onFormChange }) => {
  ...
  const default_user_field = currentPlatform === PSAFE_SECURITY_PLUGIN_OPEN_DISTRO_FOR_ELASTICSEARCH ? 'user_name' : 'username';
  const default_rule = { user_field: default_user_field, searchOperation: 'FIND', value: 'psafe' };
