        ...
        <EuiFlyoutHeader hasBorder={false}>
          <EuiTitle size="m">
            <h2>
              ...
              {PaAPIUtils.isReservedID(rule.id) && <EuiBadge color="primary">Reserved</EuiBadge>}
            </h2>
          </EuiTitle>
        </EuiFlyoutHeader>
        <EuiFlyoutBody>
          <EuiForm component="form" style={{ padding: 24 }}>
            ...
            >
              <EuiFieldText
                placeholder=""
                disabled={PaAPIUtils.isReservedID(rule.id)}
                value={ruleName}
            ...
            >
              <EuiComboBox
                ...
                isDisabled={PaAPIUtils.isReservedID(rule.id)}
          ...
          <EuiFlexGroup style={{ padding: '0px 24px 24px 24px' }}>
            <EuiFlexItem>
              <RuleEditor
                ...
                isLoading={isLoading}
                isReserved={PaAPIUtils.isReservedID(rule.id)}
