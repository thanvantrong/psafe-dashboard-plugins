...
import { PaOverlayMask } from '../../common/util';
...
export const CreateRole = ({ closeFlyout }) => {
  ...
  async function getData() {
    const policies_request = await PaRequest.apiReq('GET', '/security/policies', {});
  ...
  const createUser = async () => {
    ...
    try {
      const result = await PaRequest.apiReq('POST', '/security/roles', {
        name: roleName,
      });
      ...
      const policyResult = await PaRequest.apiReq('POST', `/security/roles/${roleId}/policies`, {
        params: {
