...
import { PSAFE_MODULES_ID, UI_LOGGER_LEVELS } from '../../../common/constants';
import { UI_ERROR_SEVERITIES } from '../../react-services/error-orchestrator/types';
import { getErrorOrchestrator } from '../../react-services/common-services'

class PaMenuAgent extends Component {
  constructor(props) {
    super(props);
    ...
    this.agentSections = {
      ...
      general: { id: PSAFE_MODULES_ID.SECURITY_EVENTS, text: 'Security Events' },
      fim: { id: PSAFE_MODULES_ID.INTEGRITY_MONITORING, text: 'Integrity Monitoring' },
      aws: { id: PSAFE_MODULES_ID.AMAZON_WEB_SERVICES, text: 'Amazon AWS' },
      gcp: { id: PSAFE_MODULES_ID.GOOGLE_CLOUD_PLATFORM, text: 'Google Cloud Platform' },
      pm: { id: PSAFE_MODULES_ID.POLICY_MONITORING, text: 'Policy Monitoring' },
      sca: { id: PSAFE_MODULES_ID.SECURITY_CONFIGURATION_ASSESSMENT, text: 'Security configuration assessment' },
      audit: { id: PSAFE_MODULES_ID.AUDITING, text: 'System Auditing' },
      oscap: { id: PSAFE_MODULES_ID.OPEN_SCAP, text: 'OpenSCAP' },
      ciscat: { id: PSAFE_MODULES_ID.CIS_CAT, text: 'CIS-CAT' },
      vuls: { id: PSAFE_MODULES_ID.VULNERABILITIES, text: 'Vulnerabilities' },
      virustotal: { id: PSAFE_MODULES_ID.VIRUSTOTAL, text: 'VirusTotal' },
      osquery: { id: PSAFE_MODULES_ID.OSQUERY, text: 'Osquery' },
      docker: { id: PSAFE_MODULES_ID.DOCKER, text: 'Docker Listener' },
      mitre: { id: PSAFE_MODULES_ID.MITRE_ATTACK, text: 'MITRE ATT&CK' },
      pci: { id: PSAFE_MODULES_ID.PCI_DSS, text: 'PCI DSS' },
      gdpr: { id: PSAFE_MODULES_ID.GDPR, text: 'GDPR' },
      hipaa: { id: PSAFE_MODULES_ID.HIPAA, text: 'HIPAA' },
      nist: { id: PSAFE_MODULES_ID.NIST_800_53, text: 'NIST 800-53' },
      tsc: { id: PSAFE_MODULES_ID.TSC, text: 'TSC' },
      github: {id: PSAFE_MODULES_ID.GITHUB, text: 'GitHub'}
    };
  ...
  async getAgentData(agentId) {
    try {
      const result = await PaRequest.apiReq('GET', '/agents/' + agentId, {});
      return result;
    } catch (error) {
      const options = {
        context: `${PaMenuAgent.name}.getAgentData`,
