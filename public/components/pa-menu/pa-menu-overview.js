...
import { hasAgentSupportModule } from '../../react-services/pa-agents';
import { PSAFE_MODULES_ID } from '../../../common/constants';
import { PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID } from '../../../common/psaf-menu/pa-menu-overview.cy';

class PaMenuOverview extends Component {
  constructor(props) {
    super(props);
    ...
    this.overviewSections = {
      ...
      general: {
        id: PSAFE_MODULES_ID.SECURITY_EVENTS,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.SECURITY_EVENTS,
        text: 'Security Events',
      },
      fim: {
        id: PSAFE_MODULES_ID.INTEGRITY_MONITORING,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.INTEGRITY_MONITORING,
        text: 'Integrity Monitoring',
      },
      aws: {
        id: PSAFE_MODULES_ID.AMAZON_WEB_SERVICES,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.AMAZON_WEB_SERVICES,
        text: 'Amazon AWS',
      },
      office: {
        id: PSAFE_MODULES_ID.OFFICE_365,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.OFFICE_365,
        text: 'Office 365',
      },
      gcp: {
        id: PSAFE_MODULES_ID.GOOGLE_CLOUD_PLATFORM,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.GOOGLE_CLOUD_PLATFORM,
        text: 'Google Cloud Platform',
      },
      pm: {
        id: PSAFE_MODULES_ID.POLICY_MONITORING,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.POLICY_MONITORING,
        text: 'Policy Monitoring',
      },
      sca: {
        id: PSAFE_MODULES_ID.SECURITY_CONFIGURATION_ASSESSMENT,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.SECURITY_CONFIGURATION_ASSESSMENT,
        text: 'Security configuration assessment',
      },
      audit: {
        id: PSAFE_MODULES_ID.AUDITING,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.AUDITING,
        text: 'System Auditing',
      },
      oscap: {
        id: PSAFE_MODULES_ID.OPEN_SCAP,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.OPEN_SCAP,
        text: 'OpenSCAP',
      },
      ciscat: {
        id: PSAFE_MODULES_ID.CIS_CAT,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.CIS_CAT,
        text: 'CIS-CAT',
      },
      vuls: {
        id: PSAFE_MODULES_ID.VULNERABILITIES,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.VULNERABILITIES,
        text: 'Vulnerabilities',
      },
      virustotal: {
        id: PSAFE_MODULES_ID.VIRUSTOTAL,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.VIRUSTOTAL,
        text: 'VirusTotal',
      },
      osquery: {
        id: PSAFE_MODULES_ID.OSQUERY,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.OSQUERY,
        text: 'Osquery',
      },
      docker: {
        id: PSAFE_MODULES_ID.DOCKER,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.DOCKER,
        text: 'Docker Listener',
      },
      mitre: {
        id: PSAFE_MODULES_ID.MITRE_ATTACK,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.MITRE_ATTACK,
        text: 'MITRE ATT&CK',
      },
      pci: {
        id: PSAFE_MODULES_ID.PCI_DSS,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.PCI_DSS,
        text: 'PCI DSS',
      },
      gdpr: {
        id: PSAFE_MODULES_ID.GDPR,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.GDPR,
        text: 'GDPR',
      },
      hipaa: {
        id: PSAFE_MODULES_ID.HIPAA,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.HIPAA,
        text: 'HIPAA',
      },
      nist: {
        id: PSAFE_MODULES_ID.NIST_800_53,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.NIST_800_53,
        text: 'NIST 800-53',
      },
      tsc: {
        id: PSAFE_MODULES_ID.TSC,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.TSC,
        text: 'TSC',
      },
      github: {
        id: PSAFE_MODULES_ID.GITHUB,
        cyTestId: PSAFE_MENU_MODULES_SECTIONS_CY_TEST_ID.GITHUB,
        text: 'GitHub',
      },
    };
  ...
  render() {
    ...
    return (
      <div className="PaManagementSideMenu pa-menu-overview">
