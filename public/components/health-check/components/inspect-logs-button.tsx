/*
 * Psafe app - Inspect Logs Button Component
 *
...
const InspectLogButton = ({ verboseIsOpen, switchVerboseDetails, haveLogs, shouldShowNotification }) => {
  ...
  >
    <EuiButtonEmpty size='xs' className={"pa-hover-transform-y1"} onClick={switchVerboseDetails} isDisabled={!haveLogs} textProps={{ style: { overflow: 'visible', position: 'relative' } }}>
      <EuiIcon
