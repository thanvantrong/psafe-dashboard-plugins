/*
* Psafe app - OpenSCAP interactive extension guide
...
export default {
  ...
  documentation_link: webDocumentationLink('user-manual/reference/optit-conf/wodle-openscap.html'),
  icon: 'securityApp',
      ...
      elements: [
        {
          ...
          attributes: [
            ...
            },
            {
              ...
              Default path: /var/optit/wodles/oscap/content`,
              type: 'input',
              required: true,
              placeholder: 'Policy file',
              default_value: '/var/optit/wodles/oscap/content',
            ...
            },
            {
              ...
              Default path: /var/optit/wodles/oscap/content`,
              type: 'input',
              placeholder: '/var/optit/wodles/oscap/content',
              default_value: '/var/optit/wodles/oscap/content',
