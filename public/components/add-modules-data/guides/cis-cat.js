/*
* Psafe app - CIS-CAT interactive interactive extension guide
...
export default {
  ...
  documentation_link: webDocumentationLink('user-manual/reference/optit-conf/wodle-ciscat.html'),
  icon: 'securityApp',
  ...
  steps: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          warning: 'For this field, it can be set a full path or a relative path. Whether you specify a relative path, it concatenates to the Psafe installation path. ciscat_path has the same behavior.',
          type: 'input',
