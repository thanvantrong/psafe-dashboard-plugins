/*
* Psafe app - System auditing interactive extension guide
...
export default {
  ...
  documentation_link: webDocumentationLink('user-manual/reference/optit-conf/localfile.html'),
  icon: 'securityApp',
  ...
  steps: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          description: `Set it to no to collect events generated since Psafe agent was stopped.
          By default, when Psafe starts it will only read all log content from a given Windows Event Channel since the agent started.
        ...
        //   name: 'query',
        //   description: 'Filter eventchannel events that Psafe will process by using an XPATH query following the event schema.',
        //   type: 'input',
