/*
* Psafe app - Vulnerabilities interactive extension guide
...
export default {
  ...
  documentation_link: webDocumentationLink('user-manual/reference/optit-conf/syscheck.html'),
  icon: 'filebeatApp',
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          info: 'This option only can be activate from the agent side, in its own optit.conf.',
          type: 'switch',
          default_value: false
        },
        {
          ...
          This option is ignored when defined at agent.conf if allow_remote_prefilter_cmd is set to no at optit.conf.`,
          type: 'input',
        ...
        },
        {
            ...
            options: [
              ...
              {
                name: 'audit_key',
                description: 'Set up the FIM engine to collect the Audit events using keys with audit_key. Psafe will include in its FIM baseline those events being monitored by Audit using audit_key. For those systems where Audit is already set to monitor folders for other purposes, Psafe can collect events generated as a key from audit_key. This option is only available for Linux systems with Audit.',
