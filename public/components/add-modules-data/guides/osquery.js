/*
* Psafe app - Osquery interactive extension guide
...
export default {
  ...
  documentation_link: webDocumentationLink('user-manual/reference/optit-conf/wodle-osquery.html'),
  icon: 'securityApp',
  ...
  steps: [
    {
      ...
      elements: [
        ...
        {
          name: 'config_path',
          description: 'Path to the Osquery configuration file. This path can be relative to the folder where the Psafe agent is running.',
          type: 'input',
          required: true,
