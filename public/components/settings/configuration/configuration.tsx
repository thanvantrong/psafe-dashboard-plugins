...
const PaConfigurationSettingsProvider = (props) => {
  ...
  useEffect(() => {
    ...
    const rawConfig = props.psafeConfig.getConfig();
...
export const PaConfigurationSettings = compose (
  withErrorBoundary,
  withReduxProvider,
  withUserAuthorizationPrompt(null, [PSAFE_ROLE_ADMINISTRATOR_NAME])
)(PaConfigurationSettingsProvider);
