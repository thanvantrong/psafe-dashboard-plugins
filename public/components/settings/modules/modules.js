...
import { UI_LOGGER_LEVELS, PSAFE_ROLE_ADMINISTRATOR_NAME } from '../../../../common/constants';
              ...
              listItems={[
                {
                  title: (
                    <span>
                      ...
                      {PSAFE_MODULES[extension.name].title}
                    </span>
                  ),
                  description: (
                    <span>{PSAFE_MODULES[extension.name].description}</span>
                  )
                }
              ]}
            />
