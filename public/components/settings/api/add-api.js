    ...
    if (this.props.errorsAtInit) {
      ...
      this.setState({
        ...
        message:
          ...
          'Psafe API not reachable, please review your configuration',
        fetchingData: false
      });
    }
  }
    ...
    try {
      ...
      const options = {
        ...
        error: {
          ...
          title: `Psafe API not reachable, please review your configuration: ${error.message || error}`,
        },
      };
  ...
  - <id>:
    ...
    const editConfigChildren = (
      <div>
        <EuiText>
          Modify{' '}
          <EuiCode>{getPluginDataPath('config/psafe.yml')}</EuiCode>{' '}
        ...
        <EuiText>
          ...
          <EuiCode>{'<api_url>'}</EuiCode> is the URL of the Psafe API,{' '}
