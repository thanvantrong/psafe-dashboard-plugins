...
import { ContextMenu } from './components/pa-search-badges';
import { qSuggests } from '.';
import './src/style/pa-search-badges.scss'
...
export class PaSearchBadges extends Component {
  props!: {
    filters: iFilter[]
    onChange: Function
  ...
  private buildQBadge(qInterpreter, index, qFilter): JSX.Element {
    ...
    return <EuiBadge className="pa-search-badge" key={index} iconType="cross"
