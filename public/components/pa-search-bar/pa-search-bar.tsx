...
import { PaSearchButtons, filterButton } from './pa-search-buttons';
import { PaSearchBadges } from './components';
...
export interface IPaSuggestItem extends apiSuggests, qSuggests {
  type: 'q' | 'params';
}

export interface IPaSearchBarProps {
  suggestions: IPaSuggestItem[];
...
export function PaSearchBar(props: IPaSearchBarProps) {
    ...
    <EuiFlexGroup>
      <EuiFlexItem>
        <EuiSuggest
          ...
          prepend={
            <PaSearchBadges filters={props.filters} onFiltersChange={props.onFiltersChange} />
          }
          value={inputValue}
