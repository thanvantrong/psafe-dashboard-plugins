...
export const TEST_CASES: tQITestCases = {
  ...
  'manager=psafe-manager-master-v4.3.4-rc1-7.10.2': {
    queryStringFilter: 'manager=psafe-manager-master-v4.3.4-rc1-7.10.2',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
        operator: '=',
        value: 'psafe-manager-master-v4.3.4-rc1-7.10.2',
      },
    ],
  },
  'and manager=psafe-manager-master-v4.3.4-rc1-7.10.2 and another': {
    queryStringFilter: null,
    expectedQueryObjects: [
      {
        conjuntion: undefined,
      ...
      },
      {
        ...
        field: 'manager',
        operator: '=',
        value: 'psafe-manager-master-v4.3.4-rc1-7.10.2 and another',
      },
    ],
  },
  'and manager=psafe-manager-master-v4.3.4-rc1-7.10.2 and another=value': {
    queryStringFilter: null,
    expectedQueryObjects: [
      {
        conjuntion: undefined,
  ...
  'manager=psafe-manager-master-v4.3.4-rc1-7.10.2 and another=value': {
    queryStringFilter: 'manager=psafe-manager-master-v4.3.4-rc1-7.10.2;another=value',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
  ...
  'manager=psafe-manager-master-v4.3.4-rc1-7.10.2 and another': {
    queryStringFilter: 'manager=psafe-manager-master-v4.3.4-rc1-7.10.2 and another',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
