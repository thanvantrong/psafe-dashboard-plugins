...
import { BaseHandler, IPaSuggestItem, QInterpreter } from './';
import { suggestItem, IPaSearchBarProps } from '../pa-search-bar';
import { queryObject } from './q-interpreter';
import { UI_LOGGER_LEVELS } from '../../../../common/constants';
import { UI_ERROR_SEVERITIES } from '../../../react-services/error-orchestrator/types';
import { getErrorOrchestrator } from '../../../react-services/common-services';

interface ISuggestHandlerProps extends IPaSearchBarProps {
  setStatus: Function;
  setIsOpen: Function;
  setInvalid: Function;
}
export class SuggestHandler extends BaseHandler {
  suggestItems: IPaSuggestItem[];
