/*
 * Psafe app - Multiple agent selector component
...
import $ from 'jquery';
import { PaFieldSearchDelay } from '../../common/search';
  ...
  class MultipleAgentSelector extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        initState: true,
        typedClasses: {
          a: 'paMultipleSelectorAdding',
          r: 'paMultipleSelectorRemoving',
        },
      };
    }
    ...
    async loadAllAgents(searchTerm, start) {
      try {
        ...
        const req = await PaRequest.apiReq('GET', '/agents', {
          params: params,
        });
    ...
    async saveAddAgents() {
      ...
      try {
        ...
        if (itemsToSave.addedIds.length) {
          await PaRequest.apiReq('PUT', `/agents/group`, {
            params: {
        ...
        if (itemsToSave.deletedIds.length) {
          await PaRequest.apiReq('DELETE', `/agents/group`, {
            params: {
              group_id: this.props.currentGroup.name,
    ...
    moveItem = (item, from, to, type) => {
      ...
      $('#paMultipleSelectorLeft').val('');
      $('#paMultipleSelectorRight').val('');
    };
                    ...
                    <EuiPanel>
                      ...
                      <EuiFlexGroup>
                        <EuiFlexItem style={{ marginTop: 30 }}>
                          <div id="paMultipleSelector">
                            <div className="paMultipleSelectorLeft">
                              <EuiPanel paddingSize="m">
                                ...
                                <select
                                  id="paMultipleSelectorLeft"
                                  size="15"
                                  multiple
                                  onChange={(e) => {
                                    this.unselectElementsOfSelectByID('paMultipleSelectorRight');
                                    this.setState(
                                      {
                                  ...
                                  className="paMultipleSelectorSelect"
                                  onDoubleClick={() => {
                                    this.moveItem(
                            ...
                            <EuiKeyPadMenu className="paMultipleSelectorButtons">
                              <EuiKeyPadMenuItem
                                label="Add all items"
                                onClick={() => {
                                  this.moveAll(
                            ...
                            <div className="paMultipleSelectorRight">
                              <EuiPanel paddingSize="m">
                                <EuiFlexGroup>
                                  <EuiFlexItem>
                                    <EuiTitle size="s">
                                ...
                                <EuiSpacer size={'m'}></EuiSpacer>
                                <select
                                  id="paMultipleSelectorRight"
                                  size="15"
                                  multiple
                                  onChange={(e) => {
                                    this.unselectElementsOfSelectByID('paMultipleSelectorLeft');
                                    this.setState(
                                      {
