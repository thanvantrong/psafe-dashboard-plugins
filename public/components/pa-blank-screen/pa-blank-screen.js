...
import { PLUGIN_PLATFORM_PSAFE_DOCUMENTATION_URL_PATH_TROUBLESHOOTING, PLUGIN_PLATFORM_URL_GUIDE, PLUGIN_PLATFORM_URL_GUIDE_TITLE } from '../../../common/constants';
import { webDocumentationLink } from '../../../common/services/web_documentation';

export class PaBlankScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        action={
          <>
            <p>
              ...
              <br />
              <br />
              <a href={webDocumentationLink(PLUGIN_PLATFORM_PSAFE_DOCUMENTATION_URL_PATH_TROUBLESHOOTING)}>Psafe installation guide</a>
            </p>
            <EuiSpacer />
