/*
 * Psafe app - Management controller
...
export class ManagementController {
  ...
  constructor($scope, $rootScope, $location, configHandler, errorHandler, $interval) {
    ...
    this.psafeManagementTabs = ['ruleset', 'groups', 'configuration'];
    ...
    this.managementProps = {
      ...
      configurationProps: {
        ...
        updatePsafeNotReadyYet: (status) => {
          this.$rootScope.psafeNotReadyYet = status;
          this.$scope.$applyAsync();
        },
        psafeNotReadyYet: () => this.$rootScope.psafeNotReadyYet,
      },
  ...
  async loadNodeList() {
    try {
      ...
      if (clusterEnabled) {
        const response = await PaRequest.apiReq('GET', '/cluster/nodes', {});
