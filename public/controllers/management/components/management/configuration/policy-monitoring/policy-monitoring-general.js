/*
 * Psafe app - React component for show configuration of policy monitoring - general tab.
...
class PaConfigurationPolicyMonitoringGeneral extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationPolicyMonitoringGeneral.propTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default PaConfigurationPolicyMonitoringGeneral;
