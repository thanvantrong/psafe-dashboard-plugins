/*
 * Psafe app - React component for show configuration of policy monitoring - system audit tab.
...
class PaPolicyMonitoringSystemAudit extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaPolicyMonitoringSystemAudit.propTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default PaPolicyMonitoringSystemAudit;
