/*
 * Psafe app - React component for show configuration of policy monitoring - ignored tab.
...
class PaConfigurationPolicyMonitoringSystemAudit extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationPolicyMonitoringSystemAudit.propTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default PaConfigurationPolicyMonitoringSystemAudit;
