/*
 * Psafe app - React component for show configuration of OpenSCAP - evaluations tab.
...
class PaConfigurationOpenScapEvaluations extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationOpenScapEvaluations.propTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default PaConfigurationOpenScapEvaluations;
