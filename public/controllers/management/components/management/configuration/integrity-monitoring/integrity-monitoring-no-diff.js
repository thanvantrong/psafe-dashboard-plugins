/*
 * Psafe app - React component for show configuration of integrity monitoring - nodiff tab.
...
class PaConfigurationIntegrityMonitoringNoDiff extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationIntegrityMonitoringNoDiff.proptTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default PaConfigurationIntegrityMonitoringNoDiff;
