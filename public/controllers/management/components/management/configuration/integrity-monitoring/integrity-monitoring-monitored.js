/*
 * Psafe app - React component for show configuration of integrity monitoring - monitored tab.
...
class PaConfigurationIntegrityMonitoringMonitored extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationIntegrityMonitoringMonitored.proptTypes = {
  // currentConfig: PropTypes.object.isRequired,
  agent: PropTypes.object
};

export default PaConfigurationIntegrityMonitoringMonitored;
