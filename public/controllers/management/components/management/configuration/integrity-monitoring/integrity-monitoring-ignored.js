/*
 * Psafe app - React component for show configuration of integrity monitoring - ignored tab.
...
class PaConfigurationMonitoringIgnored extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationMonitoringIgnored.proptTypes = {
  // currentConfig: PropTypes.object.isRequired,
  agent: PropTypes.object
};

export default PaConfigurationMonitoringIgnored;
