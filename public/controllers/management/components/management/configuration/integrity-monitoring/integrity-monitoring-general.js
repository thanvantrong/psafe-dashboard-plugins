/*
 * Psafe app - React component for show configuration of integrity monitoring - general tab.
...
import PaSettingsGroup from '../util-components/configuration-settings-group';
...
class PaConfigurationIntegrityMonitoringGeneral extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationIntegrityMonitoringGeneral.proptTypes = {
  // currentConfig: PropTypes.object.isRequired,
  agent: PropTypes.object
};

export default PaConfigurationIntegrityMonitoringGeneral;
