/*
 * Psafe app - Constants of Office365 configuration
...
export const HELP_LINKS = [
  {
    text: 'Using Psafe to monitor Office 365',
    href: webDocumentationLink('office365/index.html'),
  },
  {
    text: 'Configuration options for the module',
    href: webDocumentationLink('user-manual/reference/optit-conf/office365-module.html'),
  },
];
