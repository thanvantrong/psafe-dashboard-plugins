/*
 * Psafe app - React component GeneralTab
...
const mainSettings = [
  { field: 'enabled', label: 'Service status', render: renderValueYesThenEnabled },
  {
    ...
    label: 'Collect events generated since Psafe manager is initialized',
  },
  {
    field: 'interval',
    label:
...
export const GeneralTab = ({ agent, wodleConfiguration }: GeneralTableProps) => {
  ...
  return (
    ...
    >
      <PaConfigurationSettingsGroup config={wodleConfiguration[OFFICE_365]} items={mainSettings} />
    </PaConfigurationSettingsTabSelector>
  );
};
