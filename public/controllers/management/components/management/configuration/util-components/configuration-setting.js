/*
 * Psafe app - React component for render configuration setting.
...
class PaConfigurationSetting extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isMobile: false
...
PaConfigurationSetting.propTypes = {
  keyItem: PropTypes.string.isRequired,
  label: PropTypes.string.isRequired
  // value: PropTypes.string
};

export default PaConfigurationSetting;
