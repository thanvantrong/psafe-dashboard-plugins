/*
 * Psafe app - React component for render settings with a list selector.
...
import PaConfigurationSettingsGroup from './configuration-settings-group';
import { getUiSettings } from '../../../../../../kibana-services';

const IS_DARK_THEME = getUiSettings().get('theme:darkMode');

class PaConfigurationSettingsListSelector extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedItem: 0
...
PaConfigurationSettingsListSelector.propTypes = {
  items: PropTypes.array.isRequired,
  settings: PropTypes.array.isRequired,
  keyList: PropTypes.string
};

export default PaConfigurationSettingsListSelector;
