/*
 * Psafe app - React components for create tabs and tab.
...
class PaTabSelector extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
PaTabSelector.propTypes = {
  children: PropTypes.array.isRequired,
  spacer: PropTypes.string
};

export default PaTabSelector;

export class PaTabSelectorTab extends Component {
  constructor(props) {
    super(props);
  }
  render() {
