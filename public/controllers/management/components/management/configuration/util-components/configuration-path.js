/*
 * Psafe app - React component for title and description of configuration section.
...
import PaClusterSelect from './configuration-cluster-selector';
import { PaOverlayMask } from '../../../../../../components/common/util';

class PaConfigurationPath extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps)(PaConfigurationPath);
