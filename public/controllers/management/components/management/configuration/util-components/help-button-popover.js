/*
 * Psafe app - React component for rener help button with help links.
...
class PaHelpButtonPopover extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showHelp: false
...
PaHelpButtonPopover.propTypes = {
  links: PropTypes.array
};

export default PaHelpButtonPopover;
