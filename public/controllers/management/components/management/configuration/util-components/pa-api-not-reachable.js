/*
 * Psafe app - React component for render api isn't reachable.
...
class PaPsafeAPINotReachable extends Component {
  constructor(props) {
    super(props);
  }
  onClickRefresh = () => {
        ...
        <EuiFlexGroup>
          <EuiFlexItem>
            <div style={{ textAlign: 'center' }}>
              ...
              <span>Psafe API not reachable</span>
