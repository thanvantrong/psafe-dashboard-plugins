/*
 * Psafe app - React component for show configuration of log collection - logs tab.
...
class PaConfigurationLogCollectionLogs extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationLogCollectionLogs.propTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default PaConfigurationLogCollectionLogs;
