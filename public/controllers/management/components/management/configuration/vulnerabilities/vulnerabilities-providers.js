/*
 * Psafe app - React component for show configuration of vulnerabilities - providers tab.
...
class PaConfigurationVulnerabilitiesProviders extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
PaConfigurationVulnerabilitiesProviders.propTypes = {};

export default PaConfigurationVulnerabilitiesProviders;
