/*
 * Psafe app - React component for show configuration of log settings - archives tab.
...
import PaConfigurationSettingsGroup from '../util-components/configuration-settings-tab-selector';
...
class PaConfigurationLogSettingsArchives extends Component {
  constructor(props) {
    super(props);
  }
  render() {
...
export default PaConfigurationLogSettingsArchives;
