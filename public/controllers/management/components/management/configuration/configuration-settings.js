/*
 * Psafe app - Definitions of configuration sections.
  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        goto: 'open-scap',
        when: agent => hasAgentSupportModule(agent, PSAFE_MODULES_ID.OPEN_SCAP)
      },
      {
        name: 'CIS-CAT',
        description:
  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        when: agent => hasAgentSupportModule(agent, PSAFE_MODULES_ID.DOCKER)
      }
    ]
  },
  {
