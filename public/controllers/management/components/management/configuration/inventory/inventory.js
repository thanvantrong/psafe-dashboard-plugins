/*
 * Psafe app - React component for show configuration of inventory.
...
const helpLinks = [
  ...
  },
  {
    ...
    href: webDocumentationLink('user-manual/reference/optit-conf/wodle-syscollector.html')
  }
];

class PaConfigurationInventory extends Component {
  constructor(props) {
    super(props);
...
PaConfigurationInventory.propTypes = {
  // currentConfig: PropTypes.object.isRequired
};

export default withPaConfig(sections)(PaConfigurationInventory);
