...
class PaDecoderInfo extends Component {
  constructor(props) {
    super(props);
    ...
    const handleFileClick = async (value, item) => {
      try {
        ...
        const options = {
          context: `${PaDecoderInfo.name}.handleFileClick`,
...
export default connect(mapStateToProps, mapDispatchToProps)(PaDecoderInfo);
