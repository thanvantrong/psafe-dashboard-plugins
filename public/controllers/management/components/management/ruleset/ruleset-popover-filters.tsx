/*
 * Psafe app - React component for show filter list.
...
class PaPopoverFilters extends Component {
  filters: {
...
export default connect(mapStateToProps, mapDispatchToProps)(PaPopoverFilters);
