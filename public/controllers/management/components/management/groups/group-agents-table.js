...
import { TablePaAPI } from '../../../../../components/common/tables';
...
class PaGroupAgentsTable extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
    this.suggestions = [
  ...
  async removeItems(items) {
    ...
    try {
      ...
      const options = {
        context: `${PaGroupAgentsTable.name}.removeItems`,
...
export default connect(mapStateToProps, mapDispatchToProps)(PaGroupAgentsTable);
