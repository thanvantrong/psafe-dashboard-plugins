...
class PaGroupsActionButtons extends Component {
  _isMounted = false;
  ...
  async refresh() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtons.name}.refresh`,
  ...
  bindEnterToInput() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtons.name}.bindEnterToInput`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        store: true,
        error: {
  ...
  async createGroup() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtons.name}.createGroup`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        store: false,
        display: true,
  ...
  async generateCsv() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtons.name}.generateCsv`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        store: true,
        error: {
...
export default connect(mapStateToProps, mapDispatchToProps)(PaGroupsActionButtons);
