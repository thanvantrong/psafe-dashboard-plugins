...
import PaGroupsActionButtonsAgents from './actions-buttons-agents';
import PaGroupsActionButtonsFiles from './actions-buttons-files';
import PaGroupAgentsTable from './group-agents-table';
import PaGroupFilesTable from './group-files-table';
import { withUserAuthorizationPrompt } from '../../../../../components/common/hocs';
import { compose } from 'redux';

class PaGroupDetail extends Component {
  constructor(props) {
    super(props);
        ...
        <EuiPanel>
          <EuiFlexGroup>
            ...
            {(this.state.selectedTabId === 'agents' && (
              <PaGroupsActionButtonsAgents {...this.props} />
            )) ||
              (this.state.selectedTabId === 'files' && (
                <PaGroupsActionButtonsFiles {...this.props} />
              ))}
          </EuiFlexGroup>
          <EuiFlexGroup>
            <EuiFlexItem>
