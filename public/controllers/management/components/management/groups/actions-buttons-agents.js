...
class PaGroupsActionButtonsAgents extends Component {
  _isMounted = false;
  ...
  async refresh() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtonsAgents.name}.refresh`,
  ...
  bindEnterToInput() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtonsAgents.name}.bindEnterToInput`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        store: true,
        error: {
  ...
  async generateCsv() {
    try {
      ...
      const options = {
        context: `${PaGroupsActionButtonsAgents.name}.generateCsv`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        store: true,
        error: {
...
export default connect(mapStateToProps, mapDispatchToProps)(PaGroupsActionButtonsAgents);
