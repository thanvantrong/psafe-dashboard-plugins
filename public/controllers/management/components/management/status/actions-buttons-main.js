/*
 * Psafe app - React component of actions buttons for status.
...
class PaStatusActionButtons extends Component {
  _isMounted = false;
  ...
  async restartCluster() {
    ...
    try {
      ...
      this.setState({ isRestarting: false });
      const options = {
        context: `${PaStatusActionButtons.name}.restartCluster`,
  ...
  async restartManager() {
    ...
    try {
      ...
      this.setState({ isRestarting: false });
      const options = {
        context: `${PaStatusActionButtons.name}.restartManager`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        error: {
          error: error,
  ...
  changeNode = async e => {
    try {
      ...
      this.props.updateLoadingStatus(false);
      const options = {
        context: `${PaStatusActionButtons.name}.changeNode`,
        level: UI_LOGGER_LEVELS.ERROR,
        severity: UI_ERROR_SEVERITIES.BUSINESS,
        error: {
          error: error,
