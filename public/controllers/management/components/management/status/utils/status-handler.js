/*
 * Psafe app - Status handler service
...
export default class StatusHandler {
  ...
  static async agentsSummary() {
    try {
      const result = await PaRequest.apiReq('GET', `/agents/summary/status`, {});
      return result;
    } catch (error) {
      throw error;
    }
  ...
  static async clusterStatus() {
    try {
      const result = await PaRequest.apiReq('GET', `/cluster/status`, {});
      return result;
    } catch (error) {
      throw error;
    }
  ...
  static async managerInfo() {
    try {
      const result = await PaRequest.apiReq('GET', `/manager/info`, {});
      return result;
    } catch (error) {
      throw error;
    }
  ...
  static async managerStatus() {
    try {
      const result = await PaRequest.apiReq('GET', `/manager/status`, {});
      return result;
    } catch (error) {
      throw error;
    }
  ...
  static async lastAgentRaw() {
    try {
      const result = await PaRequest.apiReq('GET', '/agents', {
        params: {
          limit: 1,
          sort: '-dateAdd',
          q: 'id!=000'
