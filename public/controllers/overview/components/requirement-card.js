/*
 * Psafe app - React component for building a card to be used for showing compliance requirements.
 *
    ...
    const items = this.props.items.map((req, index) => {
      ...
      const cardFooterContent = (
        <EuiButtonEmpty
          iconType="iInCircle"
          size="xs"
          className="footer-req pa-margin--10"
          onClick={() => this.expand()}
        >
          {expandMessage}
        </EuiButtonEmpty>
        ...
        return (
          <EuiFlexItem key={index}>
            <EuiCard
              ...
              description={content}
              textAlign="left"
              className="pa-padding-bt-5 reqCard"
