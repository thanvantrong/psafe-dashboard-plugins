/*
 * Psafe app - React component for alerts stats.
 *
...
export const SelectAgent = withErrorBoundary (class SelectAgent extends Component {
  ...
  async getItems() {
    try {
      const rawAgents = await PaRequest.apiReq('GET', '/agents', this.buildFilter());
  ...
  render() {
    ...
    if (this.state.isFlyoutVisible) {
      flyout = (
        <EuiFlyout className="paApp" onClose={this.closeFlyout} aria-labelledby="flyoutTitle">
