...
export const configEquivalences = {
  ...
  'ip.ignore':
    'Disable certain index pattern names from being available in index pattern selector from the Psafe app.',
  'psafe.monitoring.enabled':
    'Enable or disable the psafe-monitoring index creation and/or visualization.',
  'psafe.monitoring.frequency':
    'Frequency, in seconds, of API requests to get the state of the agents and create a new document in the psafe-monitoring index with this data.',
  'psafe.monitoring.shards':
    'Define the number of shards to use for the psafe-monitoring-* indices.',
  'psafe.monitoring.replicas':
    'Define the number of replicas to use for the psafe-monitoring-* indices.',
  'psafe.monitoring.creation':
    'Define the interval in which a new psafe-monitoring index will be created.',
  'psafe.monitoring.pattern':
    'Default index pattern to use for Psafe monitoring.',
  hideManagerAlerts:
    'Hide the alerts of the manager in every dashboard.',
  'logs.level':
    'Logging level of the App.',
  'enrollment.dns':
    'Specifies the Psafe registration server, used for the agent enrollment.',
  'enrollment.password':
...
export const nameEquivalence = {
  ...
  'psafe.monitoring.enabled': 'Status',
  'psafe.monitoring.frequency': 'Frequency',
  'psafe.monitoring.shards': 'Index shards',
  'psafe.monitoring.replicas': 'Index replicas',
  'psafe.monitoring.creation': 'Index creation',
  'psafe.monitoring.pattern': 'Index pattern',
...
export const categoriesEquivalence = {
  ...
  'ip.selector': GENERAL,
  'ip.ignore': GENERAL,
  'psafe.monitoring.enabled': MONITORING,
  'psafe.monitoring.frequency': MONITORING,
  'psafe.monitoring.shards': MONITORING,
  'psafe.monitoring.replicas': MONITORING,
  'psafe.monitoring.creation': MONITORING,
  'psafe.monitoring.pattern': MONITORING,
...
export const formEquivalence = {
  ...
  'psafe.monitoring.enabled': { type: BOOLEAN },
  'psafe.monitoring.frequency': { type: NUMBER },
  'psafe.monitoring.shards': { type: NUMBER },
  'psafe.monitoring.replicas': { type: NUMBER },
  'psafe.monitoring.creation': {
    type: LIST, params: {
      options: [
        { text: 'Hourly', value: 'h' },
  ...
  'psafe.monitoring.pattern': { type: TEXT },
