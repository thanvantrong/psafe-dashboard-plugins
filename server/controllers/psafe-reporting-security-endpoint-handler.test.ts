import md5 from 'md5';
import fs from 'fs';
import { PsafeReportingCtrl } from './psafe-reporting';
...
const endpointController = new PsafeReportingCtrl();
...
describe('[security] Report endpoints guard related to a file. Parameter defines or builds the filename.', () => {
  ...
  it.each`
		...
		${'Execute endpoint handler'} | ${'admin'}     | ${'psafe-module-overview-general-1234.pdf'}          | ${false}
		${'Endpoint protected'}       | ${'admin'}     | ${'../psafe-module-overview-general-1234.pdf'}       | ${true}
		${'Endpoint protected'}       | ${'admin'}     | ${'psafe-module-overview-../general-1234.pdf'}       | ${true}
		${'Endpoint protected'}       | ${'admin'}     | ${'custom../psafe-module-overview-general-1234.pdf'} | ${true}
		${'Execute endpoint handler'} | ${'../../etc'} | ${'psafe-module-agents-001-general-1234.pdf'}        | ${false}
		${'Endpoint protected'}       | ${'../../etc'} | ${'../psafe-module-agents-001-general-1234.pdf'}     | ${true}
		${'Endpoint protected'}       | ${'../../etc'} | ${'psafe-module-overview-../general-1234.pdf'}       | ${true}
		${'Endpoint protected'}       | ${'../../etc'} | ${'custom../psafe-module-overview-general-1234.pdf'} | ${true}
	`(`$testTitle
	username: $username
	filename: $filename
...
describe('[security] GET /reports/{name}', () => {
  ...
  it.each`
		...
		${'Get report'}         | ${'admin'}     | ${'psafe-module-overview-1234.pdf'}    | ${true}
		${'Endpoint protected'} | ${'admin'}     | ${'../psafe-module-overview-1234.pdf'} | ${false}
		${'Get report'}         | ${'../../etc'} | ${'psafe-module-overview-1234.pdf'}    | ${true}
		${'Endpoint protected'} | ${'../../etc'} | ${'../psafe-module-overview-1234.pdf'} | ${false}
...
describe('[security] POST /reports', () => {
  ...
  it.each`
    ...
    if (valid) {
      ...
      expect(response.body.message).toMatch(new RegExp(`Report psafe-module-overview-${moduleID}`));
    } else {
      expect(response.body.message).toBe('5040 - You shall not pass!');
    };
  });
...
describe('[security] DELETE /reports/<filename>', () => {
  ...
  it.each`
		titleTest               | username        | filename                                    | valid
		${'Delete report'}      | ${'admin'}      | ${'psafe-module-overview-1234.pdf'}         | ${true}
		${'Endpoint protected'} | ${'admin'}      | ${'../psafe-module-overview-1234.pdf'}      | ${false}
		${'Endpoint protected'} | ${'admin'}      | ${'custom../psafe-module-overview-1234.pdf'}| ${false}
		${'Delete report'}      | ${'../../etc'}  | ${'psafe-module-overview-1234.pdf'}         | ${true}
		${'Endpoint protected'} | ${'../../etc'}  | ${'../psafe-module-overview-1234.pdf'}      | ${false}
		${'Endpoint protected'} | ${'../../etc'}  | ${'custom../psafe-module-overview-1234.pdf'}| ${false}
