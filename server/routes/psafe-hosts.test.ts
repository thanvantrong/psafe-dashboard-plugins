// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/psafe-hosts
...
describe.skip('Psafe Host', () => {
  describe('Psafe API - /hosts/apis', () => {
  ...
  describe('Psafe API - /hosts/update-hostname', () => {
  ...
  // describe('Psafe API - /hosts/remove-orphan-entries', () => {
