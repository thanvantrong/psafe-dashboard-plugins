// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/psafe-utils
...
describe.skip('Psafe API - utils', () => {
  describe('Psafe API - /utils/configuration', () => {
