/*
 * Psafe app - Module for Psafe reporting routes
 ...
 */
import { PsafeReportingCtrl } from '../controllers';
import { IRouter } from 'kibana/server';
import { schema } from '@kbn/config-schema';

export function PsafeReportingRoutes(router: IRouter) {
  const ctrl = new PsafeReportingCtrl();
