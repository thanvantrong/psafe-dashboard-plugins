// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/psafe-elastic
...
describe.skip('Psafe Elastic', () => {
  describe('Psafe API - /elastic/security/current-platform', () => {
  ...
  // describe('Psafe API - /elastic/visualizations/{tab}/{pattern}', () => {
  ...
  describe('Psafe API - /elastic/template/{pattern}', () => {
    test('[200] Check if there is some template with the pattern', () => {
      const options = buildAxiosOptions('get', '/elastic/template/psafe-alerts-*');
      return axios(options).then((response) => {
        expect(response.status).toBe(200);
  ...
  describe('Psafe API - /elastic/index-patterns/{pattern}', () => {
    test('[200] Check if there an index pattern with the pattern', () => {
      const options = buildAxiosOptions('get', '/elastic/index-patterns/psafe-alerts-*');
      return axios(options).then((response) => {
        expect(response.status).toBe(200);
        expect(typeof response.data.status).toBe('boolean');
        expect(typeof response.data.data).toBe('string');
  ...
  // TODO: This test need to be defined
  // describe('Psafe API - /elastic/top/{mode}/{cluster}/{field}/{pattern}', () => {
  //   test('[200] Check if there an index pattern with the pattern', () => {
  ...
  describe('Psafe API - /elastic/samplealerts', () => {
  ...
  describe('Psafe API - /elastic/samplealerts/{category}', () => {
  ...
  describe('Psafe API - /elastic/samplealerts/{category}', () => {
    ...
    test('[200] Create sample alers of Security category', () => {
      const options = buildAxiosOptions(
        ...
        {},
        {
          cookie: `pa-token=${userToken};pa-api=default;`,
        }
      );
      return axios(options).then((response) => {
        expect(response.status).toBe(200);
  ...
  // TODO: This test need to be defined
  // describe('Psafe API - /elastic/alerts', () => {
  //   test('[200] Check if there an sample data index of Security category', () => {
  ...
  describe('Psafe API - /elastic/statistics', () => {
    test('[200] Check if there an sample data index of Security category', () => {
