/*
 * Psafe app - Module for Agents/VirusTotal visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-Virustotal-Last-Files-Pie',
    _type: 'visualization',
    _source: {
      title: 'Last files',
  ...
  {
    _id: 'Psafe-App-Agents-Virustotal-Files-Table',
    _type: 'visualization',
    _source: {
      title: 'Files',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-Virustotal-Total-Malicious',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Virustotal-Total-Positives',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Virustotal-Malicious-Evolution',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Virustotal-Total',
    _type: 'visualization',
    _source: {
      title: 'Total',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-Virustotal-Alerts-summary',
    _type: 'visualization',
    _source: {
