/*
 * Psafe app - Module for Agents/TSC visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-TSC-Groups',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-TSC-Requirement',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-TSC-Rule-level-distribution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-TSC-Requirements',
    _source: {
      title: 'Requirements',
      visState: JSON.stringify({
        title: 'Requirements',
  ...
  {
    _id: 'Psafe-App-Agents-TSC-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
