/*
 * Psafe app - Module for Agents/Audit visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-Audit-New-files-metric',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Read-files-metric',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Modified-files-metric',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Removed-files-metric',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Groups',
    _source: {
      title: 'Groups',
      visState: JSON.stringify({
        title: 'Groups',
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Files',
    _source: {
      title: 'Files',
      visState: JSON.stringify({
        title: 'Files',
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Alerts-over-time',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Commands',
    _source: {
      title: 'Commands',
      visState: JSON.stringify({
        title: 'Commands',
  ...
  {
    _id: 'Psafe-App-Agents-Audit-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
