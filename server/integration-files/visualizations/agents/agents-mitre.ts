/*
 * Psafe app - Module for Agents/MITRE visualizations
...
export default [
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Alerts-Evolution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Attacks-By-Agent',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Level-By-Tactic',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Level-By-Attack',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Attacks-By-Tactic',
    _source: {
      title: 'Top tactics',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Top-Tactics',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-MITRE-Alerts-summary',
    _type: 'visualization',
    _source: {
