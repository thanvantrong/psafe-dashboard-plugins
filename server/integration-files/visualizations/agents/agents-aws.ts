...
export default [
  {
    _id: 'Psafe-App-Agents-AWS-Top-5-rules',
    _type: 'visualization',
    _source: {
      title: 'Top rules',
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Events-by-source',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Top-accounts',
    _type: 'visualization',
    _source: {
      title: 'Accounts',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Top-sources',
    _type: 'visualization',
    _source: {
      title: 'Sources',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Top-buckets',
    _type: 'visualization',
    _source: {
      title: 'Buckets',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Top-regions',
    _type: 'visualization',
    _source: {
      title: 'Regions',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Events-by-s3-bucket',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-AWS-Alerts-summary',
    _type: 'visualization',
    _source: {
