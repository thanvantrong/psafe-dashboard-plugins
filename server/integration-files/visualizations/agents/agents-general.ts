/*
 * Psafe app - Module for Agents/General visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-General-Top-5-alerts',
    _source: {
      title: 'Top 5 alerts',
  ...
  {
    _id: 'Psafe-App-Agents-General-Metric-alerts',
    _source: {
      title: 'Metric alerts',
      visState: JSON.stringify({
        title: 'Metric Alerts',
  ...
  {
    _id: 'Psafe-App-Agents-General-Level-12-alerts',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Authentication-failure',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Authentication-success',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Top-10-groups',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Top-5-PCI-DSS-Requirements',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Alert-groups-evolution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Alerts',
    _source: {
      title: 'Alerts',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-General-Alerts-summary',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-General-Groups-summary',
    _type: 'visualization',
    _source: {
