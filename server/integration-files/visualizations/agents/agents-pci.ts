/*
 * Psafe app - Module for Agents/PCI visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-PCI-Groups',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-PCI-Requirement',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-PCI-Rule-level-distribution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-PCI-Requirements',
    _source: {
      title: 'Requirements',
      visState: JSON.stringify({
        title: 'Requirements',
  ...
  {
    _id: 'Psafe-App-Agents-PCI-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
