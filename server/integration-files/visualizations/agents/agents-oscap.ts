/*
 * Psafe app - Module for Agents/OSCAP visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-OSCAP-Higher-score-metric',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Lower-score-metric',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Last-score',
    _source: {
      title: 'Last score',
      visState: JSON.stringify({
        title: 'Last score',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Last-scan-profile',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Scans',
    _source: {
      title: 'Scans',
      visState: JSON.stringify({
        title: 'Scans',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Profiles',
    _source: {
      title: 'Profiles',
      visState: JSON.stringify({
        title: 'Profiles',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Content',
    _source: {
      title: 'Content',
      visState: JSON.stringify({
        title: 'Content',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Severity',
    _source: {
      title: 'Severity',
      visState: JSON.stringify({
        title: 'Severity',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Daily-scans-evolution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Top-5-Alerts',
    _source: {
      title: 'Top 5 Alerts',
      visState: JSON.stringify({
        title: 'Top 5 Alerts',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Top-5-High-risk-alerts',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Top-alert',
    _source: {
      title: 'Top alert',
      visState: JSON.stringify({
        title: 'Top alert',
  ...
  {
    _id: 'Psafe-App-Agents-OSCAP-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
