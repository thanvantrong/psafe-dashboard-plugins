/*
 * Psafe app - Module for Agents/GCP visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-GCP-Top-5-rules',
    _type: 'visualization',
    _source: {
      title: 'Top 5 rules',
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Event-Query-Name',
    _type: 'visualization',
    _source: {
      title: 'Top query events',
      visState: JSON.stringify({
        title: 'Psafe-App-Agents-GCP-Query-Name',
        type: 'pie',
        params: {
          type: 'pie',
          addTooltip: true,
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Tag-Severities',
    _type: 'visualization',
    _source: {
      title: 'Severities count',
      visState: JSON.stringify({
        title: 'Psafe-App-Agents-GCP-Tag-Severities',
        type: 'tagcloud',
        params: {
          scale: 'linear',
          orientation: 'single',
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Top-5-instances',
    _type: 'visualization',
    _source: {
      title: 'Top 5 instances',
      visState: JSON.stringify({
        title: 'Psafe-App-Agents-GCP-Top-5-instances',
        type: 'pie',
        params: {
          type: 'pie',
          addTooltip: true,
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Top-5-resource-type',
    _type: 'visualization',
    _source: {
      title: 'Top 5 Events type',
      visState: JSON.stringify({
        title: 'Psafe-App-Agents-GCP-Top-5-resource-type',
        type: 'pie',
        params: {
          type: 'pie',
          addTooltip: true,
  ...
  {
    _id: 'Psafe-App-Agents-GCP-authAnswer-Bar',
    _type: 'visualization',
    _source: {
      title: 'Auth answer count',
      visState: JSON.stringify({
        title: 'Psafe-App-Agents-GCP-authAnswer-Bar',
        type: 'histogram',
        params: {
          type: 'histogram',
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Events-Over-Time',
    _type: 'visualization',
    _source: {
      title: 'GCP alerts evolution',
      visState: JSON.stringify({
        title: 'Psafe-App-Agents-GCP-Events-Over-Time',
        type: 'line',
        params: {
          type: 'line',
          grid: { categoryLines: false, valueAxis: 'ValueAxis-1' },
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Top-ResourceType-By-Project-Id',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Top-ProjectId-By-SourceType',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-GCP-Alerts-summary',
    _type: 'visualization',
    _source: {
