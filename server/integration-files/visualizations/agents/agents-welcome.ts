...
export default [
  {
    _id: 'Psafe-App-Agents-Welcome-Top-PCI',
    _type: 'visualization',
    _source: {
      title: 'Top 5 rules',
  ...
  {
    _id: 'Psafe-App-Agents-Welcome-Top-GDPR',
    _type: 'visualization',
    _source: {
      title: 'Top 5 GDPR',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-Welcome-Top-HIPAA',
    _type: 'visualization',
    _source: {
      title: 'Top 5 HIPAA',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-Welcome-Top-NIST-800-53',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-Welcome-Top-GPG-13',
    _type: 'visualization',
    _source: {
      title: 'Top 5 GPG-13',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-Welcome-Top-TSC',
    _type: 'visualization',
    _source: {
      title: 'Top 5 TSC',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Agents-Welcome-Events-Evolution',
    _type: 'visualization',
    _source: {
