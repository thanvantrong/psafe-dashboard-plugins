/*
 * Psafe app - Module for Agents/GDPR visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-GDPR-Groups',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-GDPR-Rule',
    _source: {
      title: 'Top 5 rules',
      visState: JSON.stringify({
        title: 'Top 5 rules',
  ...
  {
    _id: 'Psafe-App-Agents-GDPR-Requirement',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-GDPR-Rule-level-distribution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-GDPR-Requirements',
    _source: {
      title: 'Requirements',
      visState: JSON.stringify({
        title: 'Requirements',
  ...
  {
    _id: 'Psafe-App-Agents-GDPR-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
