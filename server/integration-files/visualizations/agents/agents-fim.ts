/*
 * Psafe app - Module for Agents/FIM visualizations
...
export default [
  {
    _id: 'Psafe-App-Agents-FIM-Users',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Actions',
    _source: {
      title: 'Actions',
      visState: JSON.stringify({
        title: 'Actions',
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Events',
    _source: {
      title: 'Events',
      visState: JSON.stringify({
        title: 'Unique events',
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Files-added',
    _source: {
      title: 'Files added',
      visState: JSON.stringify({
        title: 'Files added',
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Files-modified',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Files-deleted',
    _source: {
      title: 'Files deleted',
      visState: JSON.stringify({
        title: 'Files deleted',
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Alerts-summary',
    _type: 'visualization',
    _source: {
