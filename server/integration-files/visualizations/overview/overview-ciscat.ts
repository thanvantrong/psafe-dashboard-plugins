/*
 * Psafe app - Module for Overview/CIS-CAT visualizations
...
export default [
  {
    _id: 'Psafe-app-Overview-CISCAT-alerts-summary',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-not-checked',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-score',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-pass',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-fail',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-timestamp',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-error',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-benchmark',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-last-scan-unknown',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-top-5-groups',
    _type: 'visualization',
    _source: {
      title: 'Top 5 groups',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-app-Overview-CISCAT-scan-result-evolution',
    _type: 'visualization',
    _source: {
