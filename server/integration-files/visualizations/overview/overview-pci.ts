/*
 * Psafe app - Module for Overview/PCI visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-PCI-DSS-Requirements-over-time',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-PCI-DSS-Requirements-Agents-heatmap',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-PCI-DSS-requirements',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-PCI-DSS-Agents',
    _source: {
      title: 'Agents',
      visState: JSON.stringify({
        title: 'Agents',
  ...
  {
    _id: 'Psafe-App-Overview-PCI-DSS-Requirements-by-agent',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-PCI-DSS-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-PCI-DSS-Alerts-summary',
    _type: 'visualization',
    _source: {
