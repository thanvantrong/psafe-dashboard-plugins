/*
 * Psafe app - Module for Overview/NIST visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-NIST-Requirements-over-time',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-NIST-Requirements-Agents-heatmap',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-NIST-requirements-by-agents',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-NIST-Metrics',
    _source: {
      title: 'Stats',
      visState: JSON.stringify({
        title: 'nist-metrics',
  ...
  {
    _id: 'Psafe-App-Overview-NIST-Top-10-requirements',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-NIST-Agents',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-NIST-Alerts-summary',
    _type: 'visualization',
    _source: {
