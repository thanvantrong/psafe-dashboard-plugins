/*
 * Psafe app - Module for Overview/AWS visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-AWS-Top-5-rules',
    _type: 'visualization',
    _source: {
      title: 'Top rules',
  ...
  {
    _id: 'Psafe-App-Overview-AWS-geo',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Events-by-source',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Top-accounts',
    _type: 'visualization',
    _source: {
      title: 'Accounts',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Top-sources',
    _type: 'visualization',
    _source: {
      title: 'Sources',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Top-buckets',
    _type: 'visualization',
    _source: {
      title: 'Buckets',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Top-regions',
    _type: 'visualization',
    _source: {
      title: 'Regions',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Events-by-s3-bucket',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-AWS-Alerts-summary',
    _type: 'visualization',
    _source: {
