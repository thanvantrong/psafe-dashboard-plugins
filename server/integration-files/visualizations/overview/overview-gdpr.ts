/*
 * Psafe app - Module for Overview/GDPR visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-GDPR-Requirements-heatmap',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-GDPR-Requirements-Agents-heatmap',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-GDPR-requirements',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-GDPR-Agents',
    _source: {
      title: 'GDPR Agents',
      visState: JSON.stringify({
        title: 'GDPR Agents',
  ...
  {
    _id: 'Psafe-App-Overview-GDPR-Requirements-by-agent',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-GDPR-Last-alerts',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-GDPR-Alerts-summary',
    _type: 'visualization',
    _source: {
