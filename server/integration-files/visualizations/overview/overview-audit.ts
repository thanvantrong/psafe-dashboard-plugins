/*
 * Psafe app - Module for Overview/Audit visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-Audit-Groups',
    _source: {
      title: 'Groups',
  ...
  {
    _id: 'Psafe-App-Overview-Audit-Agents',
    _source: {
      title: 'Agents',
      visState: JSON.stringify({
        title: 'Agents',
  ...
  {
    _id: 'Psafe-App-Overview-Audit-Commands',
    _source: {
      title: 'Commands',
      visState: JSON.stringify({
        title: 'Commands',
  ...
  {
    _id: 'Psafe-App-Overview-Audit-Files',
    _source: {
      title: 'Files',
      visState: JSON.stringify({
        title: 'Files',
  ...
  {
    _id: 'Psafe-App-Overview-Audit-Alerts-over-time',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Audit-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
