/*
 * Psafe app - Module for Overview/FIM visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-FIM-Events-summary',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-FIM-Top-5-rules',
    _type: 'visualization',
    _source: {
      title: 'Top 5 rules',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-FIM-Top-5-agents-pie',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-FIM-Common-actions',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Agents-FIM-Alerts-by-action-over-time',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-FIM-top-agents-user',
    _type: 'visualization',
    _source: {
      title: 'Top users',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-FIM-Alerts-summary',
    _type: 'visualization',
    _source: {
