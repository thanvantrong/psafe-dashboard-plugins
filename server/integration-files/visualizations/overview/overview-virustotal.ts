/*
 * Psafe app - Module for Overview/VirusTotal visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-Virustotal-Last-Files-Pie',
    _type: 'visualization',
    _source: {
      title: 'Last files',
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Files-Table',
    _type: 'visualization',
    _source: {
      title: 'Files',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Total-Malicious',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Total-Positives',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Malicious-Evolution',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Total',
    _type: 'visualization',
    _source: {
      title: 'Total',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Malicious-Per-Agent-Table',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Malicious-Per-Agent',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Alerts-Evolution',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Virustotal-Alerts-summary',
    _type: 'visualization',
    _source: {
