/*
 * Psafe app - Module for Overview/Docker visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-Docker-top-5-actions',
    _type: 'visualization',
    _source: {
      title: 'Top 5 actions',
  ...
  {
    _id: 'Psafe-App-Overview-Docker-top-5-images',
    _type: 'visualization',
    _source: {
      title: 'Top 5 images',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-Docker-Events-summary',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Docker-Types-over-time',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-Docker-Actions-over-time',
    _type: 'visualization',
    _source: {
