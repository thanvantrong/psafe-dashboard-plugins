/*
 * Psafe app - Module for Overview/TSC visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-TSC-Requirements-over-time',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-TSC-Requirements-Agents-heatmap',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-TSC-requirements',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-TSC-Agents',
    _source: {
      title: 'Agents',
      visState: JSON.stringify({
        title: 'Agents',
  ...
  {
    _id: 'Psafe-App-Overview-TSC-Requirements-by-agent',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-TSC-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-TSC-Alerts-summary',
    _type: 'visualization',
    _source: {
