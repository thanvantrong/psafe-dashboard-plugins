/*
 * Psafe app - Module for Overview/General visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-General-Agents-status',
    _source: {
      title: 'Agents status',
  ...
  {
    _id: 'Psafe-App-Overview-General-Metric-alerts',
    _source: {
      title: 'Metric alerts',
      visState: JSON.stringify({
        title: 'Metric Alerts',
  ...
  {
    _id: 'Psafe-App-Overview-General-Level-12-alerts',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-General-Authentication-failure',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-General-Authentication-success',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-General-Alert-level-evolution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-General-Alerts-Top-Mitre',
    _source: {
      title: 'Alerts',
      visState: JSON.stringify({
        type: 'pie',
  ...
  {
    _id: 'Psafe-App-Overview-General-Top-5-agents',
    _source: {
      title: 'Top 5 agents',
      visState: JSON.stringify({
        title: 'Top 5 agents',
  ...
  {
    _id: 'Psafe-App-Overview-General-Top-5-agents-Evolution',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-General-Alerts-summary',
    _type: 'visualization',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-General-Alerts-evolution-Top-5-agents',
    _type: 'visualization',
    _source: {
