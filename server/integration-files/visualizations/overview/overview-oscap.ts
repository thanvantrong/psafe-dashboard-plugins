/*
 * Psafe app - Module for Overview/OSCAP visualizations
...
export default [
  {
    _id: 'Psafe-App-Overview-OSCAP-Last-score',
    _source: {
      title: 'Last score',
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Last-agent-scanned',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Last-scan-profile',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Agents',
    _source: {
      title: 'Agents',
      visState: JSON.stringify({
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Profiles',
    _source: {
      title: 'Profiles',
      visState: JSON.stringify({
        params: {
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Content',
    _source: {
      title: 'Content',
      visState: JSON.stringify({
        params: {
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Severity',
    _source: {
      title: 'Severity',
      visState: JSON.stringify({
        title: 'Severity',
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Top-5-agents-Severity-high',
    _source: {
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Top-10-alerts',
    _source: {
      title: 'Top 10 alerts',
      visState: JSON.stringify({
        title: 'Psafe App OSCAP Top 10 alerts',
        type: 'pie',
        params: {
          type: 'pie',
          addTooltip: true,
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Top-10-high-risk-alerts',
    _source: {
      title: 'Top 10 high risk alerts',
      visState: JSON.stringify({
        title: 'Psafe App OSCAP Top 10 high risk alerts',
        type: 'pie',
        params: {
          type: 'pie',
          addTooltip: true,
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Highest-score',
    _source: {
      title: 'Highest score',
      visState: JSON.stringify({
        title: 'Highest score',
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Lowest-score',
    _source: {
      title: 'Lowest score',
      visState: JSON.stringify({
        title: 'Lowest score',
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Latest-alert',
    _source: {
      title: 'Latest alert',
      visState: JSON.stringify({
        title: 'Latest alert',
  ...
  {
    _id: 'Psafe-App-Overview-OSCAP-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
