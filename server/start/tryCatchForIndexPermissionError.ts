/*
 * Psafe app - HOF to manage the message when elastic show a Response error / security_exception
...
export const tryCatchForIndexPermissionError = (psafeIndex: string) => (functionToTryCatch) => async () => {
    try {
