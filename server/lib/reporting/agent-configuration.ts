...
/*
 * Psafe app - Agent configuration request objet for exporting it
  ...
  configurations: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/client.html'),
        ...
        },
        {
          ...
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/labels.html'),
    ...
    },
    {
      ...
      sections: [
        ...
        {
          subtitle: 'OpenSCAP',
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/wodle-openscap.html'),
          desc:
        ...
        {
          subtitle: 'CIS-CAT',
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/wodle-ciscat.html'),
    ...
    },
    {
      ...
      sections: [
        {
          subtitle: 'Osquery',
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/wodle-osquery.html'),
          desc:
        ...
        },
        {
          ...
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/wodle-syscollector.html'),
          desc:
        ...
        },
        {
          ...
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/active-response.html'),
        ...
        {
          subtitle: 'Commands',
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/wodle-command.html'),
        ...
        },
        {
          ...
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/wodle-docker.html'),
          desc:
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          docuLink: webDocumentationLink('user-manual/reference/optit-conf/syscheck.html'),
          desc:
