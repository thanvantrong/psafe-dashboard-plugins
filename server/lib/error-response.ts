/*
 * Psafe app - Generic error response constructor
...
/**
 * Error codes:
 * psafe-api-elastic 20XX
 * psafe-api         30XX
 * psafe-elastic     40XX
 * psafe-reporting   50XX
 * unknown           1000
 */
/**
...
export function ErrorResponse(
  ...
  if (code) {
    ...
    if (isString && message === 'socket hang up' && code === 3005) {
      filteredMessage = 'Wrong protocol being used to connect to the Psafe API';
    } else if (
      isString &&
      ...
      filteredMessage =
        'Psafe API is not reachable. Please check your url and port.';
