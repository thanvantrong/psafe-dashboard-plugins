...
export const arrayMitreRules = [
  {
    ...
    groups: ['psafe'],
    description: 'Optit agent disconnected.',
  },
  {
    filename: '0015-optit_rules.xml',
    relative_dirname: 'ruleset/rules',
    ...
    mitre: { tactic: ['Defense Evasion'], id: ['T1089'], technique: ['Disabling Security Tools'] },
    groups: ['psafe'],
    description: 'Optit agent removed.',
  },
  {
    filename: '0015-optit_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    level: 7,
    status: 'enabled',
    details: { category: 'psafe', decoded_as: 'syscheck_integrity_changed' },
    pci_dss: ['11.5'],
    gpg13: ['4.11'],
    gdpr: ['II_5.1.f'],
  ...
  },
  {
    ...
    level: 7,
    status: 'enabled',
    details: { category: 'psafe', decoded_as: 'syscheck_deleted' },
    pci_dss: ['11.5'],
    gpg13: ['4.11'],
    gdpr: ['II_5.1.f'],
    hipaa: ['164.312.c.1', '164.312.c.2'],
  ...
  },
  {
    ...
    level: 8,
    status: 'enabled',
    details: { if_sid: '500', match: '^optit: File size reduced' },
    pci_dss: ['10.5.2', '11.4'],
    gpg13: ['10.1'],
    gdpr: ['IV_35.7.d'],
    hipaa: ['164.312.b'],
  ...
  },
  {
    ...
    level: 9,
    status: 'enabled',
    details: { if_sid: '500', match: '^optit: Event log cleared' },
    pci_dss: ['10.5.2'],
    gpg13: ['10.1'],
  ...
  },
  {
    ...
    level: 5,
    status: 'enabled',
    details: { category: 'psafe', if_sid: '550', hostname: 'syscheck-registry' },
    pci_dss: ['11.5'],
    gpg13: ['4.13'],
    gdpr: ['II_5.1.f'],
    hipaa: ['164.312.c.1', '164.312.c.2'],
  ...
  },
  {
    ...
    level: 5,
    status: 'enabled',
    details: { category: 'psafe', if_sid: '553', hostname: 'syscheck-registry' },
    pci_dss: ['11.5'],
    gpg13: ['4.13'],
    gdpr: ['II_5.1.f'],
    hipaa: ['164.312.c.1', '164.312.c.2'],
