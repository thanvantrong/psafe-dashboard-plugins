...
export const actorAttributesImage = ["psafe/psafe:3.12.0-7.6.1", "docker.elastic.co/elasticsearch/elasticsearch:7.6.2", "docker.elastic.co/kibana/kibana:7.6.2", "nginx:latest"];
...
export const dataDocker = [{
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository psafe/psafe pulled",
      id: "87932",
      firedtimes: 1,
      mail: false,
      groups: ["docker"],
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository psafe/psafe-elasticsearch pulled",
      id: "87932",
      firedtimes: 2,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "psafe/psafe-elasticsearch:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "psafe/psafe-elasticsearch:3.9.2_7.1.1",
          Attributes: {
            ...
            name: "psafe/psafe-elasticsearch",
            org: {
              "label-schema": {
                "build-date": "20190305",
                license: "GPLv2",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository psafe/psafe-kibana pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "psafe/psafe-kibana:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "psafe/psafe-kibana:3.9.2_7.1.1",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository psafe/psafe-nginx pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "psafe/psafe-nginx:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "psafe/psafe-nginx:3.9.2_7.1.1",
