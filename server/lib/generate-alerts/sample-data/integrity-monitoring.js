...
export const pathsLinux = [
  "/etc/resolv.conf",
  "/var/psafe/queue/fim/db/fim.db-journal",
  "/var/psafe/queue/fim/db/fim.db",
...
export const pathsWindows = [
  ...
  "c:\\program files (x86)\\psafe-agent\\wodles\\syscollector",
  "c:\\program files (x86)\\psafe-agent\\rids\\sender_counter",
  "c:\\program files (x86)\\psafe-agent\\queue\\fim\\db\\fim.db",
  "c:\\program files (x86)\\psafe-agent\\psafe-agent.state",
