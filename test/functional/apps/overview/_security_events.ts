...
export default function({getService, getPageObjects, }: FtrProviderContext) {
  ...
  describe('security_events', () => {
    let es_index: string;
    before(async () => {
      await PageObjects.psafeCommon.OpenSecurityEvents();
    ...
    it('should alert level evolution chart value ​​are correct',async () => {
      const chartSelector: string = '#Psafe-App-Overview-General-Alert-level-evolution';
    ...
    it('should alert chart values are correct',async () => {
      const chartSelector: string = '#Psafe-App-Overview-General-Alerts';
      const values:object = await areaChart.getValues(chartSelector);
    ...
    it('should top 5 agent chart pie values are correct',async () => {
      const chartSelector: string = '#Psafe-App-Overview-General-Top-5-agents';
    ...
    it('should top 5 rule groups chart pie values are correct',async () => {
      const chartSelector: string = '#Psafe-App-Overview-General-Top-5-rule-groups';
      const values = await pieCharts.getValues(chartSelector);
      const query:SearchParams = {
        index: es_index,
        body: {
    ...
    it('should alerts evolution - top 5 agents chart values are correct',async () => {
      const chartSelector: string = '#Psafe-App-Overview-General-Alerts-evolution-Top-5-agents';
      const values:object = await areaChart.getValues(chartSelector);
    ...
    it('should alerts summary table values are correct',async () => {
      const summarySelector: string = '#Psafe-App-Overview-General-Alerts-summary';
